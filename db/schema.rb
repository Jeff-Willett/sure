...
ActiveRecord::Schema[8.1].define(version: 2026_08_26_000100) do
  ...
  create_table "myfin_account_entities", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.check_constraint "role::text = ANY (ARRAY['owner'::character varying::text, 'joint_owner'::character varying::text, 'custodian'::character varying::text, 'reporting_only'::character varying::text])", name: "chk_myfin_account_entities_role"
  end

  create_table "myfin_category_rollup_mappings", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.datetime "created_at", null: false
    t.uuid "source_category_id", null: false
    t.uuid "target_category_id", null: false
    t.datetime "updated_at", null: false
    t.index ["source_category_id"], name: "idx_myfin_rollup_one_target_per_source", unique: true
    t.index ["target_category_id"], name: "idx_myfin_rollup_target"
    t.check_constraint "source_category_id <> target_category_id", name: "chk_myfin_rollup_distinct_categories"
  end
  ...
  create_table "myfin_category_schemes", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.string "name", null: false
    t.datetime "updated_at", null: false
    t.index ["entity_id"], name: "idx_myfin_one_default_category_scheme_per_entity", unique: true, where: "(is_default AND (entity_id IS NOT NULL))"
  ...
  create_table "myfin_classification_changes", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.check_constraint "action::text = ANY (ARRAY['edit'::character varying::text, 'revert'::character varying::text])", name: "chk_myfin_classification_changes_action"
  ...
  create_table "myfin_entities", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.check_constraint "entity_type::text = ANY (ARRAY['person'::character varying::text, 'business'::character varying::text, 'household'::character varying::text, 'other'::character varying::text])", name: "chk_myfin_entities_type"
  end
  ...
  create_table "myfin_entry_allocations", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.check_constraint "allocation_source::text = ANY (ARRAY['account_default'::character varying::text, 'manual'::character varying::text, 'rule'::character varying::text, 'import'::character varying::text])", name: "chk_myfin_entry_allocations_source"
  end
  ...
  create_table "myfin_import_batches", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.check_constraint "source_kind::text = ANY (ARRAY['google_sheet'::character varying::text, 'simplefin'::character varying::text, 'csv'::character varying::text, 'manual'::character varying::text])", name: "chk_myfin_import_batches_source_kind"
    t.check_constraint "status::text = ANY (ARRAY['pending'::character varying::text, 'running'::character varying::text, 'completed'::character varying::text, 'failed'::character varying::text])", name: "chk_myfin_import_batches_status"
  end
  ...
  create_table "myfin_review_items", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.check_constraint "reason::text = ANY (ARRAY['malformed_account'::character varying::text, 'duplicate_candidate'::character varying::text, 'ambiguous_match'::character varying::text, 'uncertain_category'::character varying::text, 'unknown_account'::character varying::text, 'invalid_row'::character varying::text, 'pending_replacement'::character varying::text])", name: "chk_myfin_review_items_reason"
    t.check_constraint "status::text = ANY (ARRAY['open'::character varying::text, 'resolved'::character varying::text, 'dismissed'::character varying::text])", name: "chk_myfin_review_items_status"
  end
  ...
  create_table "myfin_source_records", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.check_constraint "decision::text = ANY (ARRAY['created'::character varying::text, 'matched'::character varying::text, 'skipped'::character varying::text, 'review'::character varying::text])", name: "chk_myfin_source_records_decision"
  ...
  create_table "myfin_transaction_classifications", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.check_constraint "classification_source::text = ANY (ARRAY['imported'::character varying::text, 'manual'::character varying::text, 'rule'::character varying::text, 'model'::character varying::text])", name: "chk_myfin_classifications_source"
  ...
  add_foreign_key "myfin_category_rollup_mappings", "myfin_scheme_categories", column: "source_category_id", on_delete: :restrict
  add_foreign_key "myfin_category_rollup_mappings", "myfin_scheme_categories", column: "target_category_id", on_delete: :restrict
